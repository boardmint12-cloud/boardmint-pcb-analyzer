    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="bg-gray-900 rounded-2xl border border-gray-800 p-8" style={{
          ...
          <p className="text-gray-400 mb-6">Start analyzing PCBs in minutes</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">You'll be the admin of this organization</p>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-400">
              ...
              <Link to="/login" className="font-medium text-pcbGreen hover:text-green-400 transition-colors">
                Sign in
              </Link>
            </p>
          </div>
